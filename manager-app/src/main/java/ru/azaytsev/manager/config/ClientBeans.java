...
import ru.azaytsev.manager.security.OAuthClientHttpRequestInterceptor;
...
public class ClientBeans {
    ...
    public RestClientProductsRestClient productsRestClient(
            @Value("${supermag.services.catalogue.uri:http://localhost:8081}") String catalogueBaseUri,
